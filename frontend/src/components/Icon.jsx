...
const P = {
  ...
  /* ---- communication (quick replies from admin lead cards) ---- */
  mail: <><rect x="3.4" y="5.2" width="17.2" height="13.6" rx="2.6" /><path d="m4.6 7.6 7.4 5.6 7.4-5.6" /></>,
  send: <><path d="m21.2 2.8-7.4 18.4-3.6-9.2-9.2-3.6Z" /><path d="m21.2 2.8-9.4 9.4" /></>,
  phone: <path d="M5.8 3.6h2.3c.8 0 1.5.6 1.6 1.4.2 1 .5 2 .9 2.9a1.6 1.6 0 0 1-.4 1.8l-1 1a13.5 13.5 0 0 0 6.1 6.1l1-1a1.6 1.6 0 0 1 1.8-.4c.9.4 1.9.7 2.9.9.8.1 1.4.8 1.4 1.6v2.3c0 .9-.7 1.6-1.6 1.6C10.1 21.4 2.6 13.9 2.6 5.2c0-.9.7-1.6 1.6-1.6Z" />,
}
