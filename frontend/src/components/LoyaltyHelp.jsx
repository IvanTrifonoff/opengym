  ...
  return (
    <div>
      ...
      <Sec title="Вкладка «Loyalty» — правила начисления">
        ...
        <Field name="Баллы">Сколько баллов начислить за одно срабатывание. 0 — баллы не начисляются (правило работает только на достижения/уведомления). При начислении спортсмен получает push-уведомление, если в правиле не задано своё.</Field>
        ...
        <Field name="Уведомление">Push-сообщение спортсмену при срабатывании правила — мотивирует возвращаться. Если не заполнено, при начислении баллов уходит автоматическое уведомление о начислении.</Field>
