...
export default {
  ...
  "This browser doesn't support passkeys — you can still use impulseGym locally on this device.": 'Este navegador no admite passkeys — aun así puedes usar impulseGym localmente en este dispositivo.',
  ...
  'to install impulseGym as a full-screen app.': 'para instalar impulseGym como app a pantalla completa.',
  ...
  'Rest-timer alerts, even if impulseGym is closed.': 'Avisos del temporizador de descanso, incluso con impulseGym cerrado.',
  ...
  'A small file a friend imports into their own impulseGym — routines only, none of your workouts or weigh-ins.': 'Un archivo pequeño que un amigo importa en su propio impulseGym: solo rutinas, ninguno de tus entrenamientos ni pesajes.',
  ...
  'Reload impulseGym': 'Recargar impulseGym',
