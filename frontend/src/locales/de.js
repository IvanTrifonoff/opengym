...
export default {
  ...
  "This browser doesn't support passkeys — you can still use impulseGym locally on this device.": 'Dieser Browser unterstützt keine Passkeys — du kannst impulseGym trotzdem lokal auf diesem Gerät nutzen.',
  ...
  'to install impulseGym as a full-screen app.': 'um impulseGym als Vollbild-App zu installieren.',
  ...
  'Rest-timer alerts, even if impulseGym is closed.': 'Pausen-Timer-Alarm, auch wenn impulseGym geschlossen ist.',
  ...
  'A small file a friend imports into their own impulseGym — routines only, none of your workouts or weigh-ins.': 'Eine kleine Datei, die ein Freund in sein eigenes impulseGym importiert — nur Routinen, keine Workouts oder Wiegungen.',
  ...
  'this isn’t an impulseGym plan file': 'das ist keine impulseGym-Plandatei',
  'Shared routine': 'Geteilte Routine',
  'Unknown exercise': 'Unbekannte Übung',
  'Weekly Training Plan': 'Wochen-Trainingsplan',
  'Made with impulseGym': 'Erstellt mit impulseGym',
  ...
  'Reload impulseGym': 'impulseGym neu laden',
