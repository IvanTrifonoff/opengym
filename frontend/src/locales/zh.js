...
export default {
  ...
  "This browser doesn't support passkeys — you can still use impulseGym locally on this device.": '此浏览器不支持通行密钥——你仍可在本设备上本地使用 impulseGym。',
  ...
  'to install impulseGym as a full-screen app.': '即可将 impulseGym 安装为全屏应用。',
  ...
  'Rest-timer alerts, even if impulseGym is closed.': '休息计时提醒，即使 impulseGym 已关闭。',
  ...
  'A small file a friend imports into their own impulseGym — routines only, none of your workouts or weigh-ins.': '一个小文件，朋友可以导入到自己的 impulseGym——只有训练日，不包含你的训练记录或体重。',
