...
export default {
  ...
  "This browser doesn't support passkeys — you can still use impulseGym locally on this device.": 'यह ब्राउज़र पासकी सपोर्ट नहीं करता — फिर भी आप इस डिवाइस पर impulseGym लोकली इस्तेमाल कर सकते हैं।',
  ...
  'to install impulseGym as a full-screen app.': 'से impulseGym को फुल-स्क्रीन ऐप के रूप में इंस्टॉल करें।',
  ...
  'Rest-timer alerts, even if impulseGym is closed.': 'आराम टाइमर अलर्ट, impulseGym बंद होने पर भी।',
  ...
  'A small file a friend imports into their own impulseGym — routines only, none of your workouts or weigh-ins.': 'एक छोटी फ़ाइल जिसे कोई दोस्त अपने impulseGym में आयात कर सके — सिर्फ़ रूटीन, आपके वर्कआउट या वज़न नहीं।',
  ...
  'this isn’t an impulseGym plan file': 'यह impulseGym प्लान फ़ाइल नहीं है',
  'Shared routine': 'साझा किया गया रूटीन',
  'Unknown exercise': 'अज्ञात व्यायाम',
  'Weekly Training Plan': 'साप्ताहिक ट्रेनिंग प्लान',
  'Made with impulseGym': 'impulseGym से बनाया गया',
  ...
  'Reload impulseGym': 'impulseGym फिर से लोड करें',
