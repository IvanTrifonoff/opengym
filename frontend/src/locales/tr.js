...
export default {
  ...
  "This browser doesn't support passkeys — you can still use impulseGym locally on this device.": 'Bu tarayıcı geçiş anahtarlarını desteklemiyor — yine de impulseGym’i bu cihazda yerel olarak kullanabilirsin.',
  ...
  'to install impulseGym as a full-screen app.': 'ile impulseGym’i tam ekran uygulama olarak kurabilirsin.',
  ...
  'Rest-timer alerts, even if impulseGym is closed.': 'impulseGym kapalıyken bile dinlenme sayacı uyarıları.',
  ...
  'A small file a friend imports into their own impulseGym — routines only, none of your workouts or weigh-ins.': 'Bir arkadaşının kendi impulseGym\'ine aktardığı küçük bir dosya — yalnızca rutinler, antrenmanların veya tartıların değil.',
