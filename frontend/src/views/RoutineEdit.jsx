...
export default function RoutineEdit() {
  ...
  return <div className="narrow">
    ...
    <div style={{ display: 'flex', gap: 10, alignItems: 'stretch', marginBottom: 16 }}>
      <div className="sect-b" style={{ flex: 1, marginBottom: 0 }}>
      ...
      <button className="iconbtn" style={{ width: 38, height: 38, alignSelf: 'center', flex: 'none' }}
        onClick={progressionInfoSheet} aria-label={t('How progression works')} title={t('How progression works')}><Icon name="info" /></button>
    </div>
